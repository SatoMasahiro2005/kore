...
function makeURL() {
    ...
    //
    var checked = document.getElementById("c");
...
function testReq() {
    ...
    var req = new XMLHttpRequest();
    req.open("GET", "https://docs.google.com/forms/d/e/1FAIpQLSc4DpdVes76yXvM-xuYTNdOPORr2j0nUKd_sZsv52ZgRDlg5A/formResponse?entry.460698824=A");
    req.send();
    req.onreadystatechange = function () {
        if (req.readyState === 4 && req.status === 200) {
            console.log(req.responseText);
